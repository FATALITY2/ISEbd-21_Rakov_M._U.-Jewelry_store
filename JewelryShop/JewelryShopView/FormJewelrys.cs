...
{
    public partial class FormJewelrys : Form
    {
        [Dependency]
        ...
        public FormJewelrys(JewelryLogic logic)
        {
            InitializeComponent();
            this.logic = logic;
        }
        ...
        {
            var form = Container.Resolve<FormJewelry>();
        ...
        private void ButtonDel_Click(object sender, EventArgs e)
        {
            if (dataGridView.SelectedRows.Count == 1)
            {
                ...
                MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        logic.Delete(new JewelryBindingModel { Id = id });
                    }
                    catch (Exception ex)
                    {
                        MessageBox.Show(ex.Message, "Ошибка", MessageBoxButtons.OK,
