    ...
    static class SaveToWord
    {
        ...
        public static void CreateDoc(WordInfo info)
        {
            ...
            WordprocessingDocument.Create(info.FileName, WordprocessingDocumentType.Document))
            {
                ...
                foreach (var jewelry in info.Jewelrys)
                {
                    docBody.AppendChild(CreateParagraph(new WordParagraph
                    {
                        Texts = new List<(string, WordTextProperties)> {
                    (jewelry.JewelryName + " : ", new WordTextProperties {Bold = true, Size = "24", }),
                        (jewelry.Price.ToString(), new WordTextProperties {Bold = false, Size = "24", }) },
                        TextProperties = new WordTextProperties
                        {
                            Size = "24",
